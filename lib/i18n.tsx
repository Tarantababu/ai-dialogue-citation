...
const en: Dict = {
  ...
  "verify.cite.help":
    "Choose your citation style and copy it straight into your paper or book bibliography.",
...
const zh: Dict = {
  ...
  "verify.cite.help": "选择你的引用格式，直接复制到你的论文或书籍参考文献中。",
...
const hi: Dict = {
  ...
  "verify.cite.help": "अपनी उद्धरण शैली चुनें और इसे सीधे अपने शोध-पत्र या किताब की ग्रंथसूची में कॉपी करें।",
...
const es: Dict = {
  ...
  "verify.cite.help": "Elige tu estilo de cita y cópiala directo en la bibliografía de tu artículo o libro.",
...
const fr: Dict = {
  ...
  "verify.cite.help": "Choisissez votre style de citation et copiez-la directement dans la bibliographie de votre article ou livre.",
...
const ar: Dict = {
  ...
  "verify.cite.help": "اختر نمط الاستشهاد وانسخه مباشرةً إلى قائمة مراجع بحثك أو كتابك.",
...
const pt: Dict = {
  ...
  "verify.cite.help": "Escolha seu estilo de citação e copie-a direto para a bibliografia do seu artigo ou livro.",
  "verify.meta.authorName": "Autor",
...
const ru: Dict = {
  ...
  "verify.cite.help": "Выберите стиль ссылки и скопируйте её прямо в библиографию статьи или книги.",
...
const de: Dict = {
  ...
  "verify.cite.help": "Wähle deinen Zitierstil und kopiere ihn direkt in das Literaturverzeichnis deines Aufsatzes oder Buches.",
  "verify.meta.authorName": "Autor",
...
const ja: Dict = {
  ...
  "verify.cite.help": "引用スタイルを選び、論文や書籍の参考文献にそのままコピーしてください。",
...
const tr: Dict = {
  ...
  "verify.cite.help": "Atıf stilinizi seçin ve doğrudan makale veya kitap kaynakçanıza kopyalayın.",
